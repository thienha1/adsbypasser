...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: [
      {
          host: [/^(movies|anime|tech)\.dutchycorp\.space$/, /^toptap\.website$/,]
      },
      {
          host: /^dutchycorp\.space$/,
          path: /^\/link/,
      },
  ],
  async ready () {
    const a = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#cl1 a');
    await _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(a.href);
  },
});
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: /^blog\.(claimbtc|bitnity)\.(in|net)$/,
  },
  async ready () {
    const a = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#wpsafe-snp a');
    await _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(a.href);
  },
});
(function () {
  ...
  _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
    rule: [
      {
        host: /^(faupto|dogemate)\.com$/,
        path: [
          /^\/(sh|sl)\//,
        ],
      },
      {
        host: [ /^go\.links4earn\.com$/, /^dgbauto\.100count\.net/,]
      },
      {
        host: /^(theblogcash)\.in$/,
        path: [
    ...
    async ready () {
      let d = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#mdt');
      d = d.onclick.toString();
      d = d.match(/location\.href\='([^']+)'/);
      if (d) {
          await _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(d[1]);
      }
    },
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: /^(moaplos|newsonthegotoday)\.com$/,
  },
  async ready () {
    let f = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('.continuebutton');
    if (f) {
        f.click();
        return;
    }
    f = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#bt');
    f.click();
  },
});
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
...
(function () {
  ...
  _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
    rule: {
      host: [
        /^(dz4link|3rabcut|short2win|adsrt|shortglobal|jainjinvani|agradarpan|birdurls)\.com$/,
        ...
        /^(empireshort|empearn|tarnwh2i|tabeikh|yourw-ay|short88|factural|akla4|techsapparel)\.com$/,
        /^(shrinkbuck|clkpay|linksht|haxrs|click2-url|cooltxtgen|arba7co|shortlinko|ez4linkss)\.com$/,
        /^(partqb2i|khraba|adlpu|tabakhelo|amenitiees|cosmicmony|coinlyhub|a-egy|adsafelink)\.com$/,
        ...
        /^(techmen-world|razerflixs|links4earn|dislooks|elkhbrel7sry|onaah|ultraskora)\.com$/,
        /^(wrap-w0rld|ommantrameditation|mawdok|techfinda|clixg|ads-coin|popimed|click-paid)\.com$/,
        ...
        /^(techtremendous|freespinwins|w-rajem|timetoka|foodpuff|linksop|axuur)\.com$/,
        /^(linkexa|admew|shrtfly|kuylink|cut4links|adskipme|skipurls|ely-om7|brenhealth)\.com$/,
        /^(smarteasystudy|cyahealth|ershadat|z2i|srtfly|arba7kpro|linksbuddy|stategossip)\.com$/,
        /^(blogginggyanbox|yourtechguider|gifsis|3rab-cash|pinkhindi|wishes2|weawp|techupme)\.com$/,
        /^(mykinggo|li-nkz|win4cut|khabratk|programsfre|jwearn|linkwea|shorthitz)\.com$/,
        /^(linkorlink|mrfourtech|fabsdeals|tech4utoday|urlsamo|earnwithshortlink|ouofly)\.com$/,
        /^(earnmoneytalk|uptoos|bakilink|gossipcorners|slegle|futurefoundationngo)\.com$/,
        /^(loopdiet|infotaxco|newsatfit|go99tech|fullytech24|shlinko|kekolink|rifurl|ac-mo)\.com$/,
        /^(vy\.)?adsvy\.com$/,
        /^(www\.)?(clkpays|lnkjob|efshort)\.com$/,
        /^shrt(8|10)\.com$/,
        /^(trlink|wolink|tocdo|cuturl|counsellingresult2016|iitjeemainguide|theblogcash)\.in$/,
        /^(utimetableresult|daily-sale|linkszone|viraltechnical)\.in$/,
        /^(oke|cuon|cuio|cuee|cuus|cuto|linktor|flylink|uiz|uii|exe|shotly|urle)\.io$/,
        /^cu(2|3|5|6|7)\.io$/,
        ...
        /^(m|news)\.techrfour\.com$/,
        /^(100count|tinylinks|licklink|linkrex|zlshorte|vivads|owllink|bigb0ss)\.net$/,
        /^(vnurl|vinaurl|foxurl|short2win|cashat|shrtfly|shortye|ventax)\.net$/,
        /^(link4win|linksad|shortbitsfree|xemlink|directedlink)\.net$/,
        /^(click2url|ln435|merdekaid|wplink)\.online$/,
        /^(www\.)?bloggerworld\.online$/,
        /^(lotechnocan|updatetribun|templink|ez4link|shortearn|adbull|oneurls|adsrt|freebcc)\.org$/,
        /^voxc\.org$/,
        /^(clik|playstore|getlink|coiny|sturl|adsy|miniurl|chrt|pkr|bitlinks|shortit|fazo)\.pw$/,
        /^(go\.)?bitnity\.net$/,
        /^(el3id|allreports|savelink)\.site$/,
        /^123link\.carpartsviet97\.site$/,
        /^(shink|shrten|newsteller24|ashort1a|ln11|sh11|xz2|fun4earn|bitcoin-link|btcdot)\.xyz$/,
        /^(techinhub|viralnow|shophipro|technocanvas|zlink|profitstudy|buylinks)\.xyz$/,
        /^(adshr|getpocket|yasinews|dunyanews|komiupdates|allapp|smwebs|news-tech)\.ink$/,
        /^(makeeasybtc)\.website$/,
        /^(ckk|claimbtc|cashurl|bitcoinly)\.in$/,
        /^(tips\.)?atv\.pw$/,
        /^mozdream\.live$/,
        ...
        /^(link\.)?linkad\.in$/,
        /^(e2s|adsh)\.cc$/,
        /^(adzurl|link2link|pay2clik)\.cf$/,
        /^(mlink|cl250|xpickle|infosehatku)\.club$/,
        /^(short\.)?(3bst|coinlink|itiurl|altclub|link5s|curs|makeurl|gplinks|cutls)\.co$/,
        ...
        /^megaurl\.(in|link)$/,
        /^(businessiss2|techandreview|yesmoviesapp|zagl|profitlink)\.info$/,
        /^stfly\.(io|press)$/,
        /^lyon\.kim$/,
        /^fc\.lc$/,
        /^(pingit|skips|tr|flaz)\.link$/,
        /^payskip\.(me|org)$/,
        /^btc\.ms$/,
        /^splashnews\.ooo$/,
        /^express-cut\.ovh$/,
  ...
  _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: /^shortenbuddy\.com$/,
  },
  async start () {
    var a = setInterval(function() {
        if ($("button.btn.btn-primary.btn-captcha").length > 0){
            const q = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('button.btn.btn-captcha');
            q.setAttribute('id', 'invisibleCaptchaShortlink');
            clearInterval(a);
        }
    }, 500);
    await _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].wait(4000);
    const handler = new RecaptchaHandler();
    await handler.call();
  },
});
  ...
  async start () {
    var a = setInterval(function() {
        if ($("a#surl").attr("href") !== "#"){
            const q = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('a#surl');
            _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(q.href);
            clearInterval(a);
        }
    }, 500);
  ...
  async start () {
    var k = function() {
        if ($("#invisibleCaptchaShortlink").length > 0){
  ...
  _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
    rule: {
      host: [
        /^(ex-foary|safeku|dz4link|mediumarticles)\.com$/,
        /^linksoflife\.co$/,
        /^shrinkbtc\.cc$/,
        /^(cool-time\.)?dutchycorp\.(ovh|space)$/,
        /^earncoin\.site$/,
        /^fasly\.me$/,
        /^secryptzia\.xyz$/,
      ],
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: /^(www\.)?(faucetcrypto|faucet|claim4)\.(com|gold|fun)$/,
  },
  async ready () {
    await _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].wait(4 * 1000);
    const lv = _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].searchFromScripts(/window.location.href = "([^"]+)"/);
    await _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(lv[1]);
  },
});
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  ...
  async ready () {
    _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].remove('iframe');
    var a = setInterval(function() {
        if ($(".display > a").is(":visible")){
            let matches = _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"]('.display > a');
            _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(matches.href);
            clearInterval(a);
        }
    }, 500);
  },
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: /^(eth|btc|ltc)\.freebcc\.org$/,
  },
  async start () {
    var e = setInterval( function(){
            if(window.location.href.indexOf("btc.freebcc.org") > -1)
            {
                var path = window.location.href.replace('btc.', '');
                _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(path);
                clearInterval(e);
            }
        if(window.location.href.indexOf("ltc.freebcc.org") > -1)
            {
                var path1 = window.location.href.replace('ltc.', '');
                _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(path1);
                clearInterval(e);
            }
        if(window.location.href.indexOf("eth.freebcc.org") > -1)
            {
                var path2 = window.location.href.replace('eth.', '');
                _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(path2);
                clearInterval(e);
            }
        }, 1000);
  },
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: /^links\.shortenbuddy\.com$/,
  },
  async start () {
    const path = window.location.href.replace('links.', '');
    await _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(path);
  },
});
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: /^www\.xfaucet\.xyz$/,
    path: /^\/index\/[\s\S]+\/$/,
  },
  async ready () {
    var a = setInterval(function() {
        if (document.getElementById("wpsafe-link") !== null){
            let surl = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#wpsafe-link a');
            _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(surl.href);
            clearInterval(a);
        }
    }, 500);
  },
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: [ /^(sedoinfo)\.com$/, /^(techrfour)\.com$/ ]
  },
  async ready () {
    var a = setInterval(function() {
        if (document.getElementById("1") !== null){
            let surl = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('input[value=submit]');
            surl.click();
            clearInterval(a);
        }
    }, 500);
    var b = setInterval(function() {
        if (document.getElementById("form3") !== null){
            let surl = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#form3');
            surl.click();
            clearInterval(b);
        }
    }, 500);
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  ...
  async ready () {
    var a = setInterval(function() {
        if ($("#bdt").length > 0){
            let surl = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#bdt');
            surl.click();
            clearInterval(a);
        }
    }, 500);
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule: {
    host: /^(freebitcoin|freelitecoin)\.vip$/,
    path: /^\/claim\/$/,
  },
  async ready () {
    var a = setInterval(function() {
        if ($("#main-button").length > 0){
            let surl = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#main-button');
            surl.click();
        }
    }, 500);
  },
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  ...
  async ready () {
    var a = setInterval(function() {
        if ($("button.btn.btn-captcha").length > 0){
            const q = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('button.btn.btn-captcha');
            q.setAttribute('id', 'invisibleCaptchaShortlink');
    ...
    var c = setInterval(function(){
        const c = _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].$('#invisibleCaptchaShortlink');
            if (grecaptcha && grecaptcha.getResponse().length !== 0) {
                c.click();
                clearInterval(c);
            }
    ...
    var d = setInterval(function(){
        if ($("a.btn-lg.get-link").length > 0){
           const g = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('a.btn-lg.get-link');
           if (g.href !== "javascript: void(0)") {
              _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].openLink(g.href);
               clearInterval(d);
           }
        }
    }, 500);
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  rule:{
      host: /^www\.xfaucet\.xyz$/,
      path: /^\/index\/secure\/[\s\S]+$/,
  },
  async ready () {
    var b = setInterval(function(){
        if ($("input.btn.btn-primary").length > 0){
            const s = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('input.btn.btn-primary');
            s.setAttribute('id', 'invisibleCaptchaShortlink');
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  ...
  async ready () {
    var c = setInterval(function(){
        const c = _ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"].$('#goo');
            if (grecaptcha && grecaptcha.getResponse().length !== 0) {
                c.click();
            }
    }, 500);
...
_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["_"].register({
  ...
  async ready () {
    var c = setInterval(function(){
         if ($("#goo").length > 0){
            const q = Object(_ADSBYPASSER_NAMESPACE___WEBPACK_IMPORTED_MODULE_0__["$"])('#goo');
            q.click();
            clearInterval(c);
        }
    }, 500);
